...
import pandas as pd
from HandyAmpliconTool.scripts.snp_optimiser import SnpOptimiser
...
flanking_amplicons: Genotype=snp_identifier.generate_flanking_amplicons(max_seq_len=1000, max_blast_length_diff=90, min_blast_identity=60)
